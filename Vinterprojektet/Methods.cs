...
{
    public static void Game(int Princesshp, string name1)
    {
        int Dragonhp = 200;
        ...
        if (Princesshp < 1)
        {
            Console.WriteLine("You fought as ferosiously as you could, but you eventually succumbed to your injuries. You fall to the ground, the last thing you see being the callous beast walking towards your once warm corpse.");
        ...
        if (Dragonhp < 1)
        {
            Console.WriteLine("After what seems like forever, you finally manage to make the ferious beast fall to the ground, a big cloud of dust erupting from beneath its corpse as it landed with a loud thud. Finally free, you walk into the sunset, continuing your journey.");
            Console.WriteLine("YOU WIN!");
            Console.ReadLine();
        }
        
    }
    public static int ContinueWait(string choice1, string choice2, int princesshp, string name1)
    {
        if (choice1 == "a")
        {
            ...
            princesshp = Methods.breakdoor(choice1, princesshp, name1);
        }
    ...
    public static int breakdoor(string choice2, int Princesshp, string name1)
    {
        int bruise = 10;
        Princesshp -= bruise;
    ...
    internal static int ContinueWait(string choice1, int princesshp, string name1)
    {
